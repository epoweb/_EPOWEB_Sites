...
<div class="card">
	<div class="pagetitle" style="padding: 10px">
		<h1>Lista Situação para o Artigo</h1>
		<nav>
			<ol class="breadcrumb">
			<li class="breadcrumb-item">Home</li>
			<li class="breadcrumb-item active">Artigos</li>
			<li class="breadcrumb-item active">Lista Situação para o Artigo</li>
			</ol>
		</nav>
	</div><!-- End Page Title -->
	...
	<div class="card-body">
		<div class="row espaco">
			<div class="pull-right">
				<a href="administrativo.php?link=53"><button type='button' class='btn btn-sm btn-success' style="font-size:14px">Cadastrar</button></a>
			</div>
		</div>
