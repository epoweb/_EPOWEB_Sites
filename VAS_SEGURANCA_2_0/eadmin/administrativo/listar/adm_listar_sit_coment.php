...
<div class="card">
	<div class="pagetitle" style="padding: 10px">
		...
		<nav>
			...
			<li class="breadcrumb-item active">Lista de Situação Comentário Artigo</li>
			</ol>
		</nav>
	</div><!-- End Page Title -->
	...
	<div class="card-body">
		<div class="row espaco">
			<div class="pull-right">
				<a href="administrativo.php?link=81"><button type='button' class='btn btn-sm btn-success' style="font-size:14px">Cadastrar</button></a>
			</div>
		</div>
			<div class="row">
				<div class="col-md-12">
