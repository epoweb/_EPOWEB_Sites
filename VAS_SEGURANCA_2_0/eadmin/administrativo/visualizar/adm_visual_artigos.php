	...
	<div class="card-body">
		<div class="row espaco">
			<div class="pull-right">
				...
				<a href="administrativo.php?link=58&id=<?php echo $row_artigos["id"]; ?>"><button type="button" class="btn btn-sm btn-warning" style="font-size:14px">Editar</button></a>
				
				<a href="administrativo/processa/adm_apagar_artigos.php?id=<?php echo $row_artigos["id"]; ?>"><button type="button" class="btn btn-sm btn-danger" style="font-size:14px">Apagar</button></a>
			</div>
		</div>
		<dl class="dl-horizontal" style="font-size:14px">
			...
			<dt>Imagem: </dt>
			<dd>
				<img src="../foto/<?php echo $row_artigos['imagem']; ?>" width="150" height="150" style="border-radius:6px">
			</dd>
