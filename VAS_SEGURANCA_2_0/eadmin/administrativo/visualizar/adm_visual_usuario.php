	...
	<div class="card-body">
		<div class="row espaco">
			<div class="pull-right">
				...
				<a href="administrativo.php?link=4&id=<?php echo $row_usuario["id"]; ?>"><button type="button" class="btn btn-sm btn-warning" style="font-size:14px">Editar</button></a>
				
				<a href="administrativo.php?link=15&id=<?php echo $row_usuario["id"]; ?>"><button type="button" class="btn btn-sm btn-primary" style="font-size:14px">Editar Senha</button></a>
				
				<a href="administrativo/processa/adm_apagar_usuario.php?id=<?php echo $row_usuario["id"]; ?>"><button type="button" class="btn btn-sm btn-danger" style="font-size:14px">Apagar</button></a>
			</div>
		</div>
