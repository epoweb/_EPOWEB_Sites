...
<div class="card">
	<div class="pagetitle" style="padding: 10px">
		...
		<nav>
			...
			<li class="breadcrumb-item active">Visualizar Comentário</li>
			</ol>
		</nav>
	</div><!-- End Page Title -->
	...
	<div class="card-body">
		<div class="row espaco">
			<div class="pull-right">
				...
				<a href="administrativo.php?link=62&id=<?php echo $row_coment_artigos["id"]; ?>"><button type="button" class="btn btn-sm btn-warning" style="font-size:14px">Editar</button></a>
				
				<a href="administrativo/processa/adm_apagar_coment_artigos.php?id=<?php echo $row_coment_artigos["id"]; ?>"><button type="button" class="btn btn-sm btn-danger" style="font-size:14px">Apagar</button></a>
			</div>
		</div>
