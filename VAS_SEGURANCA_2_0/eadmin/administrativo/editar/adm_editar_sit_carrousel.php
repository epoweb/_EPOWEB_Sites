...
<div class="card">
	<div class="pagetitle" style="padding: 10px">
		<h1>Editar Situação do Banner</h1>
		<nav>
			<ol class="breadcrumb">
			<li class="breadcrumb-item">Home</li>
			<li class="breadcrumb-item active">Banners</li>
			<li class="breadcrumb-item active">Editar Situação do Banner</li>
			</ol>
		</nav>
	</div><!-- End Page Title -->
	...
	<div class="card-body">
		...
		<form name="adm_cad_sit_carrousel" class="form-horizontal" method="POST" action="administrativo/processa/adm_proc_edita_sit_carrousel.php" enctype="multipart/form-data" style="font-size:14px">
