	...
	<div class="card-body">
		<div class="row espaco">
			<div class="pull-right">
				<a href="administrativo.php?link=59"><button type='button' class='btn btn-sm btn-success' style="font-size:14px">Listar</button></a>
			</div>
		</div>
		<form name="adm_cad_sit_coment" class="form-horizontal" method="POST" action="administrativo/processa/adm_proc_edita_sit_coment.php" enctype="multipart/form-data" style="font-size:14px">
				...
				<div class="col-sm-10">
					...
					<?php
						if(!empty($_SESSION['value_mensag'])){
							...
							?> <textarea name="mensagem" class="form-control" rows="3" style="font-size:14px"><?php echo $row_sit_coment['mensagem']; ?>
							</textarea> <?php
						}else{
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<select class="form-control" name="artigo_id" style="font-size:14px">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<select class="form-control" name="situacoes_comentario_id" style="font-size:14px">
						<option value="">Selecione</option>
						<?php
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<input type="submit" class="btn btn-warning" value="Editar" onclick="return val_adm_cad_sit_coment()" style="font-size:14px">
				</div>
			</div>
		</form>
	</div>
