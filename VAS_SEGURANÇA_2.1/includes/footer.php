            ...
            <div class="row footer_wd_inner">
                <div class="col-lg-3 col-6">
                    <aside class="f_widget f_about_widget">
                        <center>
                            ...
                            <p>VAS Segurança e Serviços </br>
                                Rua Icanhema, 123 - CEP:04810-120 - Cidade Dutra - São Paulo - SP - Brasil
                            </p>
                            <ul class="nav">
                ...
                <div class="col-lg-3 col-6">
                    <aside class="f_widget f_contact_widget">
                        ...
                        <h4>(11) 5667-5875 | (11) 5666-0741</h4>
                        <h5>contato@vasseguranca.com.br</h5>
                    </aside>
                </div>
            </div>
        </div>
